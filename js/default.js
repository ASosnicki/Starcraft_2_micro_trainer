...
var faction = "Terran",
	...
	build_order = build_queue[0],
	current_build_queue_index = 0,
...
$(document).ready(function () {
	...
	$("#start").click(function () {
		...
		window.setInterval(function () {
			if (check_build_queue_object_requirements(build_order.queue[0])) {
				add_action_to_the_queue();
				action_queue[action_queue.length - 1].create();
			}
		}, time_between_actions); // Make sure to change time between actions.
